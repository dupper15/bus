...
const createSchedule = async (data) => {
  try {
    ...
    // 1. Check trùng lịch chạy trên cùng line & time_start
    ...
    // 2. Kiểm tra xung đột thời gian cho driver & busboy
    ...
    // 4. Sinh ID schedule mới (S001, S002,...)
