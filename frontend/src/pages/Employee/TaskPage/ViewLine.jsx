...
const ViewLine = ({ handleClose, initialData }) => {
  ...
  return (
    <div className="absolute inset-0 px-2 py-8 bg-black bg-opacity-80 -top-10 backdrop-blur-sm flex justify-center items-center">
      <div className="w-full max-w-4xl overflow-y-auto scrollbar-hide h-max bg-white shadow-lg border rounded-lg p-4 mx-4 mb-4">
        <div className="text-lg font-bold" onClick={handleClose}>
          X
        </div>
