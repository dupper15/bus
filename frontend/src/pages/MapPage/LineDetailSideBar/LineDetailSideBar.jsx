                    ...
                    <div className="py-4">
                        {isLoadingStops ? (
                            ...
                            <>
                                ...
                                {/* Stops list */}
                                <StopList
                                    stops={activeTab === 'outbound' ? line.getIntermediateStopsIterator().map(stop => stop.name).toArray() : line.getIntermediateStopsIterator().reverse().map(stop => stop.name).toArray()}
