      ...
      <div className='max-w-4xl mx-auto p-6 bg-white border border-gray-200 rounded shadow-md space-y-6'>
        <div className='grid grid-cols-2 gap-8'>
          <div>
            ...
            <div className='space-y-2'>
              <div>
                <span className='font-bold'>Name:</span> example@example.com
              </div>
              <div>
        ...
        <div className='border-t border-b py-4'>
          ...
          <div className='grid grid-cols-4 gap-4 text-sm font-medium'>
            <div>Bus Pass - monthly subscription</div>
          ...
          <div className='grid grid-cols-4 gap-4 text-sm mt-2'>
            <div>Bus Pass - monthly subscription</div>
            <div className='text-center'>US $30.00</div>
            <div className='text-center'>1</div>
            <div className='text-right'>US $30.00</div>
          </div>
        </div>
        ...
        <div className='text-sm'>
          <p>
            Order total: <span className='font-bold'>US $30</span>
          </p>
