...
const EmployeePage = () => {
  ...
  const isLoading = !currentItems.length;

  return (
    <div className='flex justify-center flex-col lg:flex-row min-h-screen  w-full bg-gray-100 px-8 py-4'>
      <div className='flex-1 basis-2/3 space-y-8 bg-white shadow-lg rounded-xl p-6 border border-gray-300'>
        ...
        <div className='overflow-x-auto rounded-lg bg-white shadow-md'>
          <Table
            className={`min-w-full  ${isEditing ? "pointer-events-none" : ""}`}>
      ...
      <div className=' w-full py-4 lg:px-4 lg:py-0 lg:basis-1/3 h-max flex justify-center items-center md:justify-start md:items-start gap-6 flex-col'>
